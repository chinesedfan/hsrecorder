...
DbConn.prototype = {
    ...
    execSqls: function(sqls) {
        ...
        self._db.transaction(function(tx) {
            for (i = 0; i < n; i++) {
                tx.executeSql(sqls[i], args[i] || [], function(tx, rs) {
    ...
    insertArenaRow: function(row, callback) {
        this.execSql(this.sqlInsertArenaRow, row, callback);
    },
    ...
    insertPacksRow: function(row, callback) {
        this.execSql(this.sqlInsertPacksRow, row, callback);
    },
    ...
    insertLacksRow: function(row, callback) {
        this.execSql(this.sqlInsertLacksRow, row, callback);
    },
